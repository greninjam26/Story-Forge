      ...
      {pendingCredential && (
        ...
        >
          ...
          <button
            type="submit"
            disabled={loading}
            className="rounded-md border border-indigo-600 px-4 py-2 text-sm font-medium text-indigo-600 disabled:opacity-50 dark:border-indigo-400 dark:text-indigo-400"
          >
